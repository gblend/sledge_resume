            ...
            <div class="nine columns main-col">
                ...
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <p class="info">Computer Science <span>&bull;</span> <em class="date">April 2010</em></p>
                ...
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <h3>School of Animation and Motion Graphics</h3>
                        <p class="info">B.A. Degree in Graphic Design <span>&bull;</span> <em class="date">March 2013</em></p>
            ...
            <div class="nine columns main-col">
                ...
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <h3>Code Academy</h3>
                        <p class="info">Senior Backend Engineer <span>&bull;</span> <em class="date">March 2014 - Present</em></p>
                ...
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <p class="info">Character Animation <span>&bull;</span> <em class="date">March 2015 - February 2016</em></p>
        ...
        <div class="row skill">
            ...
            <div class="nine columns main-col">
                ...
                <div class="bars">
                    ...
                    <ul class="skills">
                        <li><span class="bar-expand photoshop"></span><em>Vue JS</em></li>
                        <li><span class="bar-expand illustrator"></span><em>Node JS</em></li>
                        <li><span class="bar-expand wordpress"></span><em>PHP</em></li>
                        <li><span class="bar-expand css"></span><em>laravel</em></li>
                        <li><span class="bar-expand html5"></span><em>Nest JS</em></li>
